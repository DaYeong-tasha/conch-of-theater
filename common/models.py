...
class Play_list(models.Model):
    ...
    genre = models.CharField(max_length=300, blank=False, null=True) # 우리가 구분해서 추가할 장르
...
class Play_detail(models.Model):
    ...
    theater_nm = models.CharField(max_length=300, blank=False)  # 공연장명
    play_forcast = models.CharField(max_length=300, blank=False, null=True) # 출연진
    play_runtime = models.CharField(max_length=50, blank=False, null=True)  # 공연시간
    play_age = models.CharField(max_length=50, blank=False, null=True) # 관람 연령
    play_guidance = models.CharField(max_length=300, blank=False, null=True) # 가격 안내
    play_poster = models.CharField(max_length=300, blank=False, null=True) # 포스터 이미지 URL
    ...
    styurls_1 = models.CharField(max_length=300, blank=False, null=True) # 상세이미지
    styurls_2 = models.CharField(max_length=300, blank=False, null=True)
    styurls_3 = models.CharField(max_length=300, blank=False, null=True)
    styurls_4 = models.CharField(max_length=300, blank=False, null=True)
    mt10id = models.ForeignKey(Theater_location, max_length=50, on_delete=models.CASCADE, db_column='mt10id', blank=False) # 공연시설ID
    dtguidance = models.CharField(max_length=300, blank=False, null=True) # 공연 시간 안내(ex.요일별 시간)
    relate_1 = models.CharField(max_length=300, blank=False, null=True) # 예매처이름
    relateurl_1 = models.CharField(max_length=300, blank=False, null=True) # 예매처url
    relate_2 = models.CharField(max_length=300, blank=False, null=True)
    relateurl_2 = models.CharField(max_length=300, blank=False, null=True)
    relate_3 = models.CharField(max_length=300, blank=False, null=True)
    relateurl_3 = models.CharField(max_length=300, blank=False, null=True)
    relate_4 = models.CharField(max_length=300, blank=False, null=True)
    relateurl_4 = models.CharField(max_length=300, blank=False, null=True)
    relate_5 = models.CharField(max_length=300, blank=False, null=True)
    relateurl_5 = models.CharField(max_length=300, blank=False, null=True)
    relate_6 = models.CharField(max_length=300, blank=False, null=True)
    relateurl_6 = models.CharField(max_length=300, blank=False, null=True)
    relate_7 = models.CharField(max_length=300, blank=False, null=True)
    relateurl_7 = models.CharField(max_length=300, blank=False, null=True)
    relate_8 = models.CharField(max_length=300, blank=False, null=True)
    relateurl_8 = models.CharField(max_length=300, blank=False, null=True)
